...
export class PublicationService {
  ...
  savePublication(publication: Publication): Observable<any> {
    ...
    return this._http.post(this.url + "save-publication", params, {
      headers: headers,
    });
  }
  ...
  getPublicationsUser(id): Observable<any> {
    ...
    return this._http.get(this.url + "publications/" + id, {
      headers: headers,
    });
  }
  ...
  updatePublication(publication): Observable<any> {
    ...
    return this._http.put(this.url + "publication/" + publication._id, params, {
      headers: headers,
    });
  }
}
