...
export class CategoriaService {
  ...
  saveCategoria(categoria: Categoria): Observable<any> {
    ...
    return this._http.post(this.url + "save-categoria", params, {
      headers: headers,
    });
  }
  ...
  getpublicationsCategoria(id): Observable<any> {
    ...
    return this._http.get(this.url + "publicationsCategoria/" + id, {
      headers: headers,
    });
  }
  ...
  updateCategoria(categoria): Observable<any> {
    ...
    return this._http.put(this.url + "categoria/" + categoria._id, params, {
      headers: headers,
    });
  }
}
