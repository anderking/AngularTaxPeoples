...
export class ComentService {
  ...
  saveComent(coment: Coment): Observable<any> {
    ...
    return this._http.post(this.url + "save-coment", params, {
      headers: headers,
    });
  }
  ...
  getcomentsPublication(id): Observable<any> {
    ...
    return this._http.get(this.url + "comentsPublication/" + id, {
      headers: headers,
    });
  }
  ...
  updateComent(coment): Observable<any> {
    ...
    return this._http.put(this.url + "coment/" + coment._id, params, {
      headers: headers,
    });
  }
}
